        ...
        private void generateRandomNumsButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (int.TryParse(numInputTextBox.Text, out qtyRandomNums))
                {
                    ...
                    {
                        //I had this outside the showDialog if statement. I was enraged for over an hour
                        outputFile = File.CreateText(saveRandomListOfNumbers.FileName);
